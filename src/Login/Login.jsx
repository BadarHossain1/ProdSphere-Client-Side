        ...
        <div data-aos="zoom-in-up" data-aos-duration="2000" className="flex w-full max-w-sm mx-auto overflow-hidden t rounded-lg shadow-lg lg:max-w-4xl mt-6 mb-10">
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2  mx-auto">
                ...
                <div className="flex items-center justify-between mt-4 ">
                    ...
                    <a href="#" className="text-xs text-center  uppercase dark:text-gray-400 hover:underline">or</a>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <Link to='/register' className="text-xs font-Montserrat font-extrabold text-[#24A8DB]  hover:underline">Do not have an Account?</Link>

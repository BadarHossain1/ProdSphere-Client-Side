            ...
            <div>
                <footer className="footer footer-center p-10 text-base-content rounded bg-black">
                    ...
                    <nav>
                        ...
                        <p className="text-white">Contact Info: 01XXXXXXXXXX</p>
                        <p className="text-white">Email: badar12041@gmail.com</p>
                    </nav>
                    <aside>
                        <p className="text-white">Copyright © 2024 - All right reserved by Badar Hossain</p>
                    </aside>
                </footer>
            </div>
        </div>
